...
static void end_peach_cutscene_spawn_peach(struct MarioState *m) {
    ...
    if (m->actionTimer == 40) {
        ...
        sEndRightToadObj = spawn_object_abs_with_rot(gCurrentObject, 0, MODEL_LUIGI2, bhvLuigi2, 200,
                                                     906, -1290, 0, 0, 0);

        sEndLeftToadObj = spawn_object_abs_with_rot(gCurrentObject, 0, MODEL_WARIO, bhvWario, -200,
                                                    906, -1290, 0, 0, 0);
