...
const LevelScript level_wmotr_entry[] = {
	...
	AREA(1, wmotr_area_1),
		...
		OBJECT(MODEL_NONE, 31, 1663, -137, 0, 0, 0, 1, bhvBirdsSoundLoop),
	...
	AREA(2, wmotr_area_2),
		WARP_NODE(0x0A, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_BOWSER_BOMB, 49, 1635, 5916, 0, 0, 0, 200, bhvBowserBomb),
		OBJECT(MODEL_NONE, 7, 1560, -4, 0, 0, 0, 2, bhvBirdsSoundLoop),
		OBJECT(MODEL_NONE, -36, 2385, -17, 0, 0, 0, 0x000A0000, bhvInstantActiveWarp),
		TERRAIN(wmotr_area_2_collision),
		MACRO_OBJECTS(wmotr_area_2_Area_root_2_macro_objs),
		SET_BACKGROUND_MUSIC(0x00, SEQ_EVENT_RACE),
		TERRAIN_TYPE(TERRAIN_GRASS),
	END_AREA(),
